...
class CarvanaDatasetBCE(Dataset):
...
class CarvanaDatasetCE(Dataset):
...
def loadTrainingData(cfg, labeler=None):
    ...
    if cfg.loss_fn == "bce":            
        ...
        train_ds = CarvanaDatasetBCE(train_imgs, img_transf, train_masks, mask_transf)
        #get the validation dataset
        val_ds = CarvanaDatasetBCE(val_imgs, img_transf, val_masks, mask_transf)
 
    elif cfg.loss_fn == "ce":     
        #get the training dataset 
        train_ds = CarvanaDatasetCE(train_imgs, img_transf, train_masks, mask_transf)
        #get the validation dataset
        val_ds = CarvanaDatasetCE(val_imgs, img_transf, val_masks, mask_transf)
...
def loadTestData(cfg, labeler=None, gt_mask=False):
    ...
    if cfg.loss_fn == "bce":            
        ...
        test_ds = CarvanaDatasetBCE(img_paths, img_transf, mask_paths, mask_transf)
    elif cfg.loss_fn == "ce":                    
        #get the test dataset
        test_ds = CarvanaDatasetCE(img_paths, img_transf, mask_paths, mask_transf)
