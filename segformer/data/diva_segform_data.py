...
class DivaDataset(Dataset):
    """ Dataset processor for DIVA training and test dataset """
...
def loadTrainingData(cfg, labeler, feature_extractor):
    ...
    train_ds = DivaDataset(feature_extractor, train_imgs[:10], train_masks[:10], labeler)
    #get the validation dataset
    val_ds = DivaDataset(feature_extractor, val_imgs, val_masks, labeler)
...
def loadTestData(cfg, labeler, feature_extractor, gt_mask=False):
    ...
    test_ds = DivaDataset(feature_extractor, test_img_paths, test_mask_paths, labeler)
