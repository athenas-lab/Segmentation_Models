...
"""
    Fine-tune Segformer model from HuggingFace using Salt geological dataset
    and evaluate to identify areas of salt deposit.
"""
...
if __name__ == "__main__":
    ...
    if mode == "train":
        ...
        model = f"./results/{data_name}/{model_name}/checkpoint-1350"
